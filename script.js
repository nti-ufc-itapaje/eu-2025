...
window.addEventListener("DOMContentLoaded", () => {
    ...
    msg.textContent =
        "Bem-vindo ao site dos Encontros Universitários da UFC de Itapajé!"
...
addEventListener("click", (e) => {
    ...
    t.style.transition =
        "background 0.4s, color 0.4s, box-shadow 0.4s, transform 0.3s, opacity 0.3s"
...
const navAnchors = links
    ? Array.from(links.querySelectorAll("a")).filter((a) =>
...
ver_edital.onclick = () => {
    window.open(
        "https://itapaje.ufc.br/wp-content/uploads/2025/08/sei-5816356-edital-05-2025-1.pdf",
        "_blank"
    )
}
